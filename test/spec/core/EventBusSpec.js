...
describe('core/EventBus', function() {
  ...
  describe('basic behavior', function() {
    ...
    it.only('should call listeners after once listener', function() {
    ...
    describe.only('adding listener during <emit>', function() {
      ...
      it.only('should NOT call higher priority listener', function() {
